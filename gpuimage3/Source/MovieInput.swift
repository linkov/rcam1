...
public class MovieInput: ImageSource {
    ...
    public init(asset:AVAsset, playAtActualSpeed:Bool = false, loop:Bool = true) throws {
        self.asset = asset
    ...
    public convenience init(url:URL, playAtActualSpeed:Bool = false, loop:Bool = true) throws {
